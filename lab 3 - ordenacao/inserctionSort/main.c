...
void insertionSort (Item  array[], int n, char* string){
...
void entrada(char* caminho1, char* caminho2, char* caminho3, char* tipo){
    ...
    printf("Análise de tempo do insertionSort para entrada - %s:\n", tipo);
    ...
    fclose(arquivo1k);
    insertionSort(array1k, i, "Tempo insertionSort array 1k:");
    ...
    fclose(arquivo10k);
    insertionSort(array10k, i, "Tempo insertionSort array 10k:");
    ...
    insertionSort(array100k, i, "Tempo insertionSort array 100k:");
